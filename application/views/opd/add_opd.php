                ...
                <li class="list-group-item">
                  ...
                  <form class="forms-sample" action="" method="post">
                    ...
                    <div class="form-group col-12">
                      ...
                      <input type="text" class="form-control" id="nama_opd" placeholder="Masukan Nama Opd" name="nama_opd">
                      <?= form_error('nama_opd', '<small class="text-danger pl-2">', '</small>'); ?>
                    </div>
                    
                    <div class="form-group col-12">
                      <label for="singkatan">Singkatan</label>
                      <input type="text" class="form-control" id="singkatan" placeholder="Masukan Singkatan Opd" name="singkatan">
