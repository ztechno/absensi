        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="nip" placeholder="Masukan nip" name="nip" value="<?= $data->nip ?>" disabled>
                ...
                <div class="form-group">
                  ...
                  ?>
                  <input type="text" class="form-control" id="nama" placeholder="Masukan Nama" name="nama" value="<?= $nama ?>" disabled>
                ...
                <div class="form-group">
                  ...
                  <select class="select2 form-control" name="skpd_id" disabled>
                      ...
                      <?php foreach($skpsd as $opd):?>
                        <option value="<?=$opd->id_skpd?>" <?= $data->id_skpd == $opd->id_skpd ? "selected" : null ?> ><?=$opd->nama_skpd  ?></option>
                      <?php endforeach;?>
                  </select>
...
$(document).ready(function() {
    ...
    function getPegawaiAtasan(){
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url() . '/user/selectOptionPegawaiAtasan?token=' . $_GET['token']; ?>",
            data: {
                skpd_id:skpd_id
            },
